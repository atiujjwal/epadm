  ...
  return (
    <div className="contact-page">
      ...
      <style>{`
        ...
        .contact-page__info { display: flex; flex-direction: column; gap: var(--space-6); }
        ...
        .contact-page__channels { display: flex; flex-direction: column; gap: var(--space-4); }
        ...
        .contact-page__channel > div { display: flex; flex-direction: column; gap: 2px; }
        ...
        .contact-page__success h3 { font-size: var(--text-xl); font-weight: var(--weight-bold); color: var(--text-primary); margin: 0; }
        .contact-page__success p { font-size: var(--text-sm); color: var(--text-secondary); margin: 0; }
        ...
        @media (max-width: 640px) {
          .contact-page__form-wrap { padding: var(--space-6); }
        }
      `}</style>
    </div>
  );
