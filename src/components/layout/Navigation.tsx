      ...
      <style>{`
        ...
        .nav {
          ...
          transition:
            ...
            border-bottom-color var(--duration-normal) var(--ease-default),
        ...
        .nav__mobile-sub-item {
          ...
          border-radius: var(--radius-md);
          text-decoration: none;
          transition: color var(--duration-fate), background var(--duration-fate);
        }

        .nav__mobile-sub-item:hover {
          color: var(--text-primary);
          background: var(--color-white-06);
        }
