...
import { InnerRail, type InnerRailGroup } from "@/components/inner-rail";
import { PageToolbar, Pagination } from "@/components/page-toolbar";
...
export const Route = createFileRoute("/attendance")({
  head: () => ({
    meta: [
      { title: "Attendance · EPADM" },
      { name: "description", content: "Mark, review, and analyse student attendance with grade/section filters, monthly and annual reports, and AI-flagged absentees." },
    ],
  }),
